...
d="Gleison Morais"
print(d.replace("Gleison","Morais")) #A função var.replace(content) substitui temporariamente as informações de uma string.

e="Gleison-Morais-da-Silva"
print(e.split("-")) #Irá substituir o sinal indicado por vírgulas. 

f="Gleison Morais da Silva"
print(f.find("Silva")) #Acha o primeiro índice do string indicado. Da esquerda para a direita.
print(f.rfind("Silva")) #Acha o primeiro índice do string indicado. Da direita para a esquerda. 
