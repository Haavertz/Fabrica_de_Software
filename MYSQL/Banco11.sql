...
("Rio Negro", "MS", "CENTRO-OESTE", "jan/21", 2),
...
select * from ms;
select * from ms limit 2; #Vai limitar ate o 2 registro
...
select * from ms order by vitima;
...
select count(vitima) from ms; #somando tudo
select avg(vitima) from ms; #Media

select * from ms where municipio like "a%a"; #Busca a tabela
select * from ms where municipio like "_a%"; #Busca na segunda palavra
